...
async def process_link(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_action == "video_download":
        await update.message.reply_text("Kindly provide the YouTube link to initiate the video download process.")
        try:
        ...
        await update.message.reply_text("Kindly provide the YouTube link to initiate the audio download process.")
        try:
