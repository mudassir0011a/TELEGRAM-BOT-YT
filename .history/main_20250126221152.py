...
async def set_bot_commands(application: Application):
    commands = [
        ...
        BotCommand("video_download", "Download a YouTube video"),
        BotCommand("audio_download", "Download YouTube audio"),
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "Please choose an option below or use the commands from the menu.",
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "/video_download - Start a video download task.\n"
        "/audio_download - Start an audio download task.\n"
...
async def video_download(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("Please send the YouTube link for the **video download**.")
...
async def audio_download(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("Please send the YouTube link for the **audio download**.")
...
async def process_link(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("What would you like to do next? Use /new_task to start over.")
...
async def new_task(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("New task started! Choose an option below or use the menu.")

# Handle unknown commands
async def unknown_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Command not recognized. Use /help to see available commands.")
