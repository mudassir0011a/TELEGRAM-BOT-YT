...
# Custom INFO logger
info_logger = logging.getLogger("__main__")
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    info_logger.info(f"User {user_name} started the bot.")
...
async def video_download_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("Please send the YouTube link to download the video.")
...
async def audio_download_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("Please send the YouTube link to download the audio.")
...
# Main function
async def main():
    info_logger.info("Starting the bot...")
    ...
    info_logger.info("Bot is running. Waiting for user interactions...")
